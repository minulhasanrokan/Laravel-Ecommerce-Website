...
--
-- Host: localhost
-- Generation Time: Aug 02, 2022 at 07:37 PM
...
CREATE TABLE `customers` (
  ...
  `customer_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
('admin@gmail.com', '$2y$10$MwHKkUOO5qW5ZeFdv10LE.rMDd55vvLTX9EM5LUAX5zDovzuGWqci', '2022-06-22 10:17:03');
...
ALTER TABLE `products`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `products_product_url_unique` (`product_url`);
